    ...
    public void onPlayerClickChessPiece(ChessboardPoint point, view.ChessComponent component) //选中棋子判断捕捉
    {
        if (selectedPoint == null) //selectedpoint是本来选中的点
        {
            if (model.getChessPieceOwner(point).equals(currentPlayer)) {
                ...
                component.repaint();
                findavailablecapture(point);
                findavailablemove(point);
...
//        System.out.println("Serialized data is saved in " + absolutePath);
    ...
    public void print(List<ChessboardPoint> chessboardPoints)
    {
        ...
        {
            System.out.println(chessboardPoints.get(i).toString());
        }
    }
    ...
    public JLabel showCurrentUser(){
        JLabel showCurrentUser=new JLabel(String.format("当前回合：%s 倒计时：", currentPlayer));
        showCurrentUser.setFont(new Font("宋体", Font.PLAIN, 20));
        showCurrentUser.setSize(400,60);
        showCurrentUser.setLocation(810,81+420);
        return showCurrentUser;
    }
//    public JLabel showRedUser(){
//        JLabel showRedUser=new JLabel(String.format("红方用户：%s", userRed));
//        showRedUser.setFont(new Font("宋体", Font.PLAIN, 10));
//        showRedUser.setSize(400,30);
//        showRedUser.setLocation(50,30);
//        return showRedUser;
//    }
//    public JLabel showBlueUser(){
//        JLabel showRedUser=new JLabel(String.format("蓝方用户：%s", userBlue));
//        showRedUser.setFont(new Font("宋体", Font.PLAIN, 10));
//        showRedUser.setSize(400,30);
//        showRedUser.setLocation(50,60);
//        return showRedUser;
//    }
