...
//                view.clear(view.getGameController().getModel());
    ...
    public void onPlayerClickChessPiece(ChessboardPoint point, ChessComponent component) //选中棋子判断捕捉
    {
        if(isMovable) {
...
//public List<Step> loadGameFromFile() {
//
//    // 尝试反序列化List<Person>对象
//    try {
//        JFileChooser fileChooser = new JFileChooser();
...
//        {
//            String selectedpath = fileChooser.getSelectedFile().getPath();
//            List<Step> deserializedSteps = deserializeSteps(selectedpath);
//            setTime(10);
//            return deserializedSteps;
//        }
//        else {
